                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="email" class="block text-sm font-medium text-gray-700">Email
                            Address</label>
                        <input type="text" id="email" autocomplete="email" wire:model='form.email'
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                        <div class="text-red-500">@error('form.email') {{ $message }} @enderror</div>
                    </div>

                    <div class="col-span-6 sm:col-span-4">
                        <label for="avatar" class="block text-sm font-medium text-gray-700">Avatar</label>
                        <input type="file" id="avatar" wire:model='form.image'
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                        <div class="text-red-500">@error('form.image') {{ $message }} @enderror</div>
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="text-red-500">@error('form.section_id') {{ $message }} @enderror</div>
                    </div>
                </div>
            </div>
